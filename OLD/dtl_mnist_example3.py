...
def main(_):
    ...
    p1 = dtl.Conv(r1,filter_shape=[3,3,10,10],
                      strides = [1,2,2,1],
                      padding = 'VALID',
                      name = 'conv_stride_pool1')

    
    cl2 = dtl.Conv(p1, filter_shape = [3,3,10,25],
                       strides=[1,1,1,1],
                       padding='VALID',name='conv2')
    r2 = dtl.Relu(cl2)
    #p2 = dtl.AvgPool(r2,[2,2],'avg_pool2')
    p2 = dtl.Conv(r2,filter_shape=[3,3,25,25],
                      strides = [1,2,2,1],
                      padding = 'VALID',
    ...
    flat = dtl.Flatten(p2)
    cl3 = dtl.Conv(p2, filter_shape = [3,3,25,100],
                       strides=[1,1,1,1],
                       padding='VALID',name='conv3')
    r3 = dtl.Relu(cl3)
    #p3 = dtl.AvgPool(r3,[2,2],'avg_pool3')
    p3 = dtl.Conv(r3,filter_shape=[3,3,100,100],
                      strides = [1,2,2,1],
                      padding = 'VALID',
