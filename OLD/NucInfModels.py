...
class NucConvModel:
    def __init__(self,seq_len,num_classes,**kwargs):
        ...
        self.dna_pool_size = 4 #Max or average pooling param

        self.num_fc1_neurons = 512
        self.num_fc2_neurons = 512
        self.num_fc3_neurons = 256
        self.num_fc4_neurons = 256

        self.pad_size=0
        """
        (Optional) Overwrite some default network params.
        This option should be set in the .json params file under
        "training_params":"custom_model_params"
        ...
        for kw in kwargs:
            ...
            if kw == 'dna_conv_filter_width' :
                self.dna_conv_filter_width = kwargs[kw]
            elif kw == 'num_dna_filters':
                self.num_dna_filters = kwargs[kw]
            elif kw == 'dna_pool_size':
                ...
                print "num_fc4_neurons:", self.num_fc4_neurons
            elif kw == 'pad_size':
                self.pad_size = kwargs[kw]
    ...
    def inferenceB_600bp(self,dna_seq_placeholder,keep_prob_placeholder):
        print "Utilizing inferenceB_600bp"
        """A fully convolutional network for DNA"""
        """After some testing, I can assert that this works quite poorly"""
        pad_size=12
    ...
    def inferenceC_600bp(self,dna_seq_placeholder,keep_prob_placeholder):
    ...
    def inferenceC_600bp_tester(self,dna_seq_placeholder,keep_prob_placeholder):
        print "Running inferenceC for 600 bp input sequence"
        pad_size=0
        x_nuc = dtl.NucInput(dna_seq_placeholder,pad_size,'dna_input')
    ...
    def inferenceC_600bp_lite(self,dna_seq_placeholder,keep_prob_placeholder):
        print "Running inferenceC for 600 bp input sequence"
        pad_size=12
        x_nuc = dtl.NucInput(dna_seq_placeholder,pad_size,'dna_input')
    ...
    def inferenceD(self,dna_seq_placeholder,keep_prob_placeholder):
    ...
    def inferenceE(self,dna_seq_placeholder,keep_prob_placeholder):
